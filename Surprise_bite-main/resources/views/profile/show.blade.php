            ...
            <form id="profile-form" method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <script>
                    (function () {
                        ...
                        // Handle form submission to properly refresh avatar
                        var form = document.getElementById('profile-form');
                        form?.addEventListener('submit', function (e) {
                            // If avatar input has a file, clear preview before submit
                            // so currentWrap shows after page reload
                            ...
                            // Add cache-busting to all avatar images after form submit
                            // This ensures new image is loaded after page reload
                            setTimeout(function () {
                                var avatarImg = document.getElementById('profile-avatar-current-photo');
                                if (avatarImg && avatarImg.src) {
                                    var url = avatarImg.src.split('?')[0];
