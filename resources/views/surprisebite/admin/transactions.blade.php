    ...
    >
        ...
        <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-[24px] px-6 pb-6 pt-6 text-white shadow-[0_20px_25px_0px_rgba(0,0,0,0.1),0px_8px_10px_0px_rgba(0,0,0,0.1)]"
                ...
                <p class="mt-2 text-4xl font-black">{{ $moneyShort($summary['revenue_idr']) }}</p>
            </div>
            <div class="rounded-2xl border-2 border-[#dcfce7] bg-white px-6 pb-6 pt-6 shadow-[0_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)]">
                ...
                <p class="mt-2 text-4xl font-black text-[#00a63e]">{{ number_format($summary['completed']) }}</p>
            </div>
            <div class="rounded-2xl border-2 border-black/10 bg-white px-6 pb-6 pt-6 shadow-[0_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)]">
                ...
                <p class="mt-2 text-4xl font-black text-[#f54900]">{{ number_format($summary['pending']) }}</p>
            </div>
            <div class="rounded-2xl border-2 border-black/10 bg-white px-6 pb-6 pt-6 shadow-[0_10px_15px_0px_rgba(0,0,0,0.1),0px_4px_6px_0px_rgba(0,0,0,0.1)]">
                <div class="flex items-center gap-3">
                ...
                <p class="mt-2 text-4xl font-black text-[#e7000b]">{{ number_format($summary['failed']) }}</p>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse ($orders as $order)
                            ...
                            <tr class="border-b border-[#f3f4f6] last:border-0 hover:bg-slate-50/80">
                                ...
                                <td class="px-4 py-5 align-middle font-bold text-[#1e2939]">{{ $order->customer?->name ?? '—' }}</td>
