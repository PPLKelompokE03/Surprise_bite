            ...
            <div class="lg:grid lg:min-h-[580px] lg:grid-cols-[1fr_1.05fr]">
                ...
                <div class="order-1 flex flex-col justify-center px-8 py-10 sm:px-10 lg:order-2 lg:px-12 lg:py-14">
                    <div class="mx-auto w-full max-w-md">
                        ...
                        <p class="mt-2 text-sm text-[#6a7282]">Gunakan akun yang sudah kamu daftarkan (bukan akun admin).</p>
                        ...
                        <p class="mt-6 text-center text-xs text-[#9ca3af]">
                            <a href="{{ route('login.admin') }}" class="font-bold text-[#00a63e] hover:underline">Login Admin (panel pengelolaan)</a>
                        </p>
                    </div>
                </div>
            </div>
